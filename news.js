const allSites=[['lineToday','LINE'],['anue','鉅亨'],['dw','德國之聲'],['ctee','工商'],['udn','聯合'],['wealth','財訊'],['businessToday','今周刊'],['businessWeekly','商周'],['bnext','數位時代'],['technews','科技新報'],['msnTW','MSN 台灣'],['msnUS','MSN'],['peInsights','PEI']];
...
const dw=[['線上報導/s-9058','最新'],['經濟/s-1682','經濟'],['政治/s-1681','政治'],['科技創新/s-1686','科技創新'],['文化/s-1683','文化'],['台灣/s-68398524','台灣']];
...
async function dwGetList(siteName,t){
  ...
  d=d[Object.keys(d)[0]].data.content.contentComposition.informationSpaces[0];
