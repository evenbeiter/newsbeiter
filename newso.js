...
async function udnGetContent(clickedId,id){
  ...
  if (cEl.style.display=='none' || cEl.style.display==''){
    ...
    if (a) {
      var html = '<p class="fs10">'+t.innerText+'</p>'+a.outerHTML + '<p class="text-end"><a href="https://udn.com' + id + '" target="_blank">分享</a></p><br>';
      cEl.innerHTML=html;
