...
const note=[['2025','2025'],['standalone','主題']];
...
const searchSites=[['lineToday','LINE'],['yahooTW','奇摩'],['cna','中央社'],['cnyes','鉅亨'],['wscn','華爾街見聞'],['ctee','工商'],['wealth','財訊'],['udnMoney','經濟日報'],['businessToday','今周刊'],['businessWeekly','商周'],['note','筆記']]; 
...
<div class="sticky-top position-fixed m-2 top-0 end-0" style="z-index:1030;padding-top:3rem">
  ...
  <br>
  <button id="notebookBtn" type="button" class="btn btn-light mt-2 sepia-contrast opacity-25" onclick="get1stList('note','筆記','')">
...
async function yahooTWGetList(siteName,t){
  try{coun='.atoms';
  if (t.slice(-2)=='__'){t=t.slice(0,-2);coun='.caas-body'};
