        ...
        if (siteName=='blk'){
          try{
            ...
            for (let b of blkIframe){
              b.outerHTML+=`
              <p class="text-end"><button type="button" class="safe-click btn btn-light" onclick="showOverlay('blkIframe','${b.src}')">
