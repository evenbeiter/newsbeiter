...
const faq=[['wscn','華爾街見聞','美股'],['ctee','工商','美債'],['udnMoney','經濟日報','日股'],['wscn','華爾街見聞','私募']];
...
async function getList(siteName,t){
  ...
  else {list.innerHTML+=await (await fetch(`https://newsbeiter.onrender.com/api/getList?src=${siteName}&t=${t}&rr=${rr}`)).text();}
